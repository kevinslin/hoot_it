...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_userprofile', (
            ...
            ('birthday', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(1970, 1, 1, 23, 17, 30))),
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'birthday': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(1970, 1, 1, 23, 17, 30)'}),
