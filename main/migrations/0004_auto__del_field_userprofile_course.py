...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_userprofile', 'course_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('main_userprofile', 'course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Course'], null=True), keep_default=False)
