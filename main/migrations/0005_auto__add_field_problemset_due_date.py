...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProblemSet.due_date'
        db.add_column('main_problemset', 'due_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2012, 3, 11)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProblemSet.due_date'
        db.delete_column('main_problemset', 'due_date')
